...
- <a name="todo"></a> Comparing continual task learning in minds and machines
 (**PNAS2018**) [paper](Comparing continual task learning in minds and machines)]
...
- <a name="todo"></a> Piggyback: Adapting a Single Network to Multiple Tasks by Learning to Mask Weights (**ECCV2018**) [[paper](https://arxiv.org/abs/1801.06519)] 
 - <a name="todo"></a> Memory Aware Synapses: Learning what (not) to forget (**ECCV2018**) [[paper](https://arxiv.org/abs/1711.09601)] 
